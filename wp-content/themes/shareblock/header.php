...
<!--[if IE 9 ]><html class="ie ie9" <?php language_attributes(); ?>><![endif]-->
   <html <?php language_attributes(); ?>>
      ...
      <body <?php body_class();?>>         
        ...
        ?>
         <div class="options_layout_wrapper jl_clear_at jl_none_box_styles jl_border_radiuss <?php echo shareblock_day_night();?> <?php if(get_theme_mod('enable_dark_skin')){echo 'options_dark_skin';}else{echo ' jl_en_day_night';}?>">         
         <div class="options_layout_container full_layout_enable_front <?php echo esc_attr($jl_header_tp);?>">        
         <?php
         $jl_hide_topbar = get_post_meta( get_the_ID(), 'jl_hide_topbar', true );
         if(empty($jl_hide_topbar)) {
            if(function_exists('shareblock_topbar')){shareblock_topbar();}
         }
